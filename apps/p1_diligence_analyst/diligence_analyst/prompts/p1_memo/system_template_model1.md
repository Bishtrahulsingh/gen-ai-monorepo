...
- INFERENTIAL: a conclusion that follows directly from verbatim or derivable claims, no new numbers
...
Writing rules:
- executive_summary: answer the query in the first sentence, then 1–3 sentences of supporting insight. Be analytical, not descriptive.
...
Full:
{"executive_summary": "...", "key_risks": [{"risk": "...", "severity": "low|medium|high", "evidence": "..."}], "open_questions": [{"question": "specific missing data point", "decision_impact": "what this blocks"}]}
