...
class PyPIRepository(BaseRepository):
    ...
    def _get_project(self, ireq: InstallRequirement) -> Any:
        ...
        InstallRequirement. Return None on HTTP/JSON error or if a packages
        ...
        for package_index in package_indexes:
            ...
            try:
                ...
                log.debug(f"Fetch packages info from PyPI failed: {url}: {e}")
                continue

            # Skip this PyPI server, because there is no packages
