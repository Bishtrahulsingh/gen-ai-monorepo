...
MESSAGE_UNHASHED_PACKAGE = comment(
    "# WARNING: pip install will require the following packages to be hashed."
...
MESSAGE_UNSAFE_PACKAGES_UNPINNED = comment(
    ...
    "\n# satisfied by a packages already installed. "
...
class OutputWriter:
    ...
    def write_format_controls(self) -> Iterator[str]:
        ...
        #
        # So in summary, we want to emit :all: first and then packages names later.
    ...
    def _iter_lines(
        ...
        # Check for unhashed or unpinned packages if at least one packages does have
    ...
    def _format_requirement(
        ...
        # Annotate what packages or reqs-ins this packages is required by
        required_by = set()
