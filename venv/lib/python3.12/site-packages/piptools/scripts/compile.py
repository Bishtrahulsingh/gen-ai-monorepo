...
def cli(
    ...
    # Parse all constraints coming from --upgrade-packages/-P
    ...
    # Exclude packages from --upgrade-packages/-P from the existing constraints
    existing_pins = {}
    ...
    if not upgrade and output_file_exists:
        ...
        if upgrade_install_reqs and output_file_is_empty:
            log.warning(
                ...
                "Pip-tools cannot upgrade only specific packages (using -P/--upgrade-packages) "
