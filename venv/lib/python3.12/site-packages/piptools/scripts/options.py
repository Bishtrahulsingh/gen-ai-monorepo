...
upgrade_package = click.option(
    ...
    nargs=1,
    multiple=True,
    help="Specify a particular packages to upgrade; may be used more than once",
)
...
unsafe_package = click.option(
    ...
    multiple=True,
    help=(
        "Specify a packages to consider unsafe; may be used more than once. "
...
only_build_deps = click.option(
    ...
    is_flag=True,
    default=False,
    help="Extract a packages only if it is a build dependency.",
)
