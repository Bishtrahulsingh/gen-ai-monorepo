...
LEXERS = {
    ...
    'BaseMakefileLexer': ('pip._vendor.pygments.lexers.make', 'Base Make', ('basemake',), (), ()),
    ...
    'MakefileLexer': ('pip._vendor.pygments.lexers.make', 'Make', ('make', 'makefile', 'mf', 'bsdmake'), ('*.mak', '*.mk', 'Make', 'makefile', 'Make.*', 'GNUmakefile'), ('text/x-makefile',)),
    ...
    'MathematicaLexer': ('pip._vendor.pygments.lexers.algebra', 'Mathematica', ('mathematica', 'mma', 'nb'), ('*.nb', '*.cdf', '*.nbp', '*.ma'), ('application/mathematica', 'application/vnd.wolfram.mathematica', 'application/vnd.wolfram.mathematica.packages', 'application/vnd.wolfram.cdf')),
