...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # Path to any downloaded or already-existing packages.
    ...
    def is_pinned(self) -> bool:
        ...
        For example, some-packages==1.2 is pinned; some-packages>1.2 is not.
        """
        assert self.req is not None
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            "Generating metadata for packages %s "
...
def check_invalid_constraint_type(req: InstallRequirement) -> str:
    ...
    if problem:
        deprecated(
            reason=(
                "Constraints are only allowed to take the form of a packages "
