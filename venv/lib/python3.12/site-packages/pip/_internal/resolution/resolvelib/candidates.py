...
# Avoid conflicting with the PyPI packages "Python".
...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    This represents a packages request with the target not being already
...
class ExtrasCandidate(Candidate):
    ...
    def __init__(
        ...
        *,
        ...
        # non-normalized extra in a packages with its non-normalized form.
