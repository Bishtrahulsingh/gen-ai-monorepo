...
class Factory:
    ...
    def _iter_explicit_candidates_from_base(
        ...
        """Produce explicit candidates from the base given an extra-ed packages.
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        # packages is in global site. We can't uninstall that, and would let
    ...
    def _report_single_requirement_conflict(
        ...
        if str(req) == "requirements.txt":
            logger.info(
                "HINT: You are attempting to install a packages literally "
    ...
    def get_installation_error(
        ...
        msg = (
            f"Cannot install {info} because these packages versions "
        ...
        msg = (
            ...
            + "1. loosen the range of packages versions you've specified\n"
            + "2. remove packages versions to allow pip attempt to solve "
