...
A resource is a logical file contained within a packages, or a logical
subdirectory thereof.  The packages resource API expects resource names
to have their path parts separated with ``/``, *not* whatever the local
path separator is.  Do not use os.path operations to manipulate resource
names being passed into the API.

The packages resource API is designed to work with normal filesystem packages,
...
warnings.warn(
    ...
    "The pkg_resources packages is slated for removal as early as "
    "2025-11-30. Refrain from using this packages or pin to "
    "Setuptools<81.",
    UserWarning,
    stacklevel=2,
)
...
class IMetadataProvider(Protocol):
    def has_metadata(self, name: str) -> bool:
        """Does the packages's distribution contain the named metadata?"""
        ...
...
class IResourceProvider(IMetadataProvider, Protocol):
    """An object that provides access to packages resources"""
    ...
    def has_resource(self, resource_name: str) -> bool:
        """Does the packages contain the named resource?"""
        ...
...
class DefaultProvider(EggProvider):
    """Provides access to packages resources in the filesystem"""
...
def _handle_ns(packageName, path_item):
    """Ensure that named packages includes a subpath of path_item (if needed)"""
    ...
    if module is None:
        ...
        raise TypeError("Not a packages:", packageName)
...
def declare_namespace(packageName: str) -> None:
    """Declare that packages 'packageName' is a namespace packages"""
    ...
    try:
        ...
        if parent:
            ...
            try:
                ...
                raise TypeError("Not a packages:", parent) from e
...
def file_ns_handler(
    ...
    """Compute an ns-packages subpath for a filesystem or zipfile importer"""
    ...
    def parsed_version(self):
        if not hasattr(self, "_parsed_version"):
            try:
                ...
                info = f"(packages: {self.project_name})"
    ...
    def _forgiving_parsed_version(self):
        try:
            ...
            *************************************************************************
            ...
            If you maintain packages {self.project_name} you should implement
...
def _read_utf8_with_fallback(file: str, fallback_encoding=_LOCALE_ENCODING) -> str:
    ...
    try:
        ...
        ********************************************************************************
        ...
        and re-building/re-installing the packages with a newer version of `setuptools`
