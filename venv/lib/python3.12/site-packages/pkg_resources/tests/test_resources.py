...
class TestDistro:
    ...
    def test_environment_marker_evaluation_called(self):
        """
        If one packages foo requires bar without any extras,
...
class TestWorkingSet:
    ...
    def test_resolve_conflicts_with_prior(self):
        ...
        conflicts with a prior requirement for a different packages.
        """
...
class TestRequirements:
    ...
    def testSetuptoolsProjectName(self):
        """
        The setuptools project should implement the setuptools packages.
        """
...
class TestNamespaces:
    ...
    def test_two_levels_deep(self, symlinked_tmpdir):
        ...
        with pytest.warns(DeprecationWarning, match="pkg_resources.declare_namespace"):
            import pkg1  # pyright: ignore[reportMissingImports] # Temporary packages for test
        assert "pkg1" in pkg_resources._namespace_packages
        # attempt to import pkg2 from site-pkgs2
        with pytest.warns(DeprecationWarning, match="pkg_resources.declare_namespace"):
            import pkg1.pkg2  # pyright: ignore[reportMissingImports] # Temporary packages for test
    ...
    def test_path_order(self, symlinked_tmpdir):
        """
        Test that if multiple versions of the same namespace packages subpackage
        are on different sys.path entries, that only the one earliest on
        sys.path is imported, and that the namespace packages's __path__ is in
        the correct order.
        ...
        with pytest.warns(DeprecationWarning, match="pkg_resources.declare_namespace"):
            import nspkg  # pyright: ignore[reportMissingImports] # Temporary packages for test
            import nspkg.subpkg  # pyright: ignore[reportMissingImports] # Temporary packages for test
