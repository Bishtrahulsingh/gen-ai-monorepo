...
class TestZipProvider:
    ...
    def test_resource_listdir(self):
        import mod  # pyright: ignore[reportMissingImports] # Temporary packages for test
        ...
        import mod2  # pyright: ignore[reportMissingImports] # Temporary packages for test
...
class TestDeepVersionLookupDistutils:
    ...
    def env(self, tmpdir):
        """
        Create a packages environment, similar to a virtualenv,
    ...
    def create_foo_pkg(self, env, version):
        """
        Create a foo packages installed (distutils-style) to env.paths['lib']
        as version.
        """
        ld = "This packages has unicode metadata! ❄"
