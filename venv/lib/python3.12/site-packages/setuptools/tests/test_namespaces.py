...
class TestNamespaces:
    ...
    def test_pkg_resources_import(self, tmpdir):
        """
        Ensure that a namespace packages doesn't break on import
        of pkg_resources.
        """
    ...
    def test_namespace_package_installed_and_cwd(self, tmpdir):
        ...
        # ensure that packages imports and pkg_resources imports
        pkg_resources_imp = [
            sys.executable,
            '-c',
    ...
    def test_packages_in_the_same_namespace_installed_and_cwd(self, tmpdir):
        """
        Installing one namespace packages and also have another in the same
