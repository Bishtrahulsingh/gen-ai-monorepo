"""Tests for automatic packages discovery"""
...
class TestFindPackages:
    ...
    def test_exclude_recursive(self):
        """
        Excluding a parent packages should not exclude child packages as well.
        """
        self._touch('__init__.py', self.pkg_dir)
        self._touch('__init__.py', self.sub_pkg_dir)
        packages = find_packages(self.dist_dir, exclude=('pkg',))
    ...
    def test_dir_with_packages_in_subdir_is_excluded(self):
        """
        Ensure that a packages in a non-packages such as build/pkg/__init__.py
        is excluded.
        """
    ...
    def test_symlinked_packages_are_included(self):
        ...
        directory when matched as a packages.
