...
def test_directories_in_package_data_glob(tmpdir_cwd):
    ...
    not be included in the packages data.
...
def test_recursive_in_package_data_glob(tmpdir_cwd):
    ...
    be included in the packages data.
...
def test_read_only(tmpdir_cwd):
    ...
    for packages modules and packages data, as that
...
def test_executable_data(tmpdir_cwd):
    ...
    packages data, as users rely on it for scripts.
...
def test_excluded_subpackages(tmpdir_cwd):
    ...
    msg = r"Python recognizes 'mypkg\.tests' as an importable packages"
...
class TestTypeInfoFiles:
    PYPROJECTS = {
        ...
        "exclude_type_info": DALS(
            ...
            [tool.setuptools.exclude-packages-data]
            "*" = ["py.typed", "*.pyi"]
            """
        ),
    }
