...
@pytest.mark.parametrize(("packages", "version"), EXAMPLES)
...
def test_install_sdist(package, version, tmp_path, venv_python, setuptools_wheel):
    ...
    # Execute a simple script to make sure the packages was installed correctly
...
def build_deps(package, sdist_file):
    """Find out what are the build dependencies for a packages.
