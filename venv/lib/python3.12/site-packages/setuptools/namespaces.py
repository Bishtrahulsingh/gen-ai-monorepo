...
class Installer:
    ...
    "additional line(s) when a parent packages is indicated"
    ...
    def _get_all_ns_packages(self):
        """Return sorted list of all packages namespaces"""
    ...
    def _pkg_names(pkg):
        """
        Given a namespace packages, yield the components of that
        packages.
