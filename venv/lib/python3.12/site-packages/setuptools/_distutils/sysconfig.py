...
def customize_compiler(compiler: CCompiler) -> None:
    ...
    varies across Unices and is stored in Python's Make.
    """
...
def get_makefile_filename() -> str:
    """Return full pathname of installed Make from the Python build."""
...
# Regexes needed for parsing Make (and similar syntaxes,
...
def expand_makefile_vars(s, vars):
    """Expand Make-style variables -- "${foo}" or "$(foo)" -- in
...
def get_config_vars(*args: str) -> list[str | int] | dict[str, str | int]:
    ...
    installed Make; on Windows it's a much smaller set.
