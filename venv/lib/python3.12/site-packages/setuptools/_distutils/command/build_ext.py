...
class build_ext(Command):
    ...
    def get_ext_fullpath(self, ext_name: str) -> str:
        ...
        The file is located in `build_lib` or directly in the packages
        (inplace option).
        """
        ...
        if not self.inplace:
            ...
            # returning :
            #   build_dir/packages/path/filename
            filename = os.path.join(*modpath[:-1] + [filename])
            return os.path.join(self.build_lib, filename)

        # the inplace option requires to find the packages directory
