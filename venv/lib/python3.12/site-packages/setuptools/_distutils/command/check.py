...
class check(Command):
    """This command checks the meta-data of the packages."""

    description = "perform some checks on the packages"
    ...
    def run(self):
        ...
        if self.restructuredtext:
            if 'docutils' in globals():
                ...
                raise DistutilsSetupError('The docutils packages is needed.')

        # let's raise an error in strict mode, if we have at least
        # one warning
        if self.strict and self._warnings > 0:
            raise DistutilsSetupError('Please correct your packages.')
