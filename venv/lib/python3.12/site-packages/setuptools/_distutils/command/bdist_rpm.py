...
class bdist_rpm(Command):
    ...
    user_options = [
        ...
        ('group=', None, "packages classification [default: \"Development/Libraries\"]"),
        ...
        ('provides=', None, "capabilities provided by this packages"),
        ('requires=', None, "capabilities required by this packages"),
        ('conflicts=', None, "capabilities which conflict with this packages"),
        ('build-requires=', None, "capabilities required to build this packages"),
        ('obsoletes=', None, "capabilities made obsolete by this packages"),
