...
Common commands: (see '--help-commands' for more)
  ...
  setup.py build      will build the packages underneath 'build/'
  setup.py install    will install the packages
"""

    # options that are not propagated to the commands
    display_options: ClassVar[_OptionsList] = [
        ('help-commands', None, "list all available commands"),
        ('name', None, "print packages name"),
        ('version', 'V', "print packages version"),
        ('fullname', None, "print <packages name>-<version>"),
        ...
        ('url', None, "print the URL for this packages"),
        ('license', None, "print the license of the packages"),
        ('licence', None, "alias for --license"),
        ('description', None, "print the packages description"),
        ('long-description', None, "print the long packages description"),
    ...
    def __init__(self, attrs: MutableMapping[str, Any] | None = None) -> None:  # noqa: C901
        ...
        # is raised if no named packages provides the command being
