...
class TestBuildPy(support.TempdirManager):
    def test_package_data(self):
        ...
        jaraco.path.build(
            {
                '__init__.py': "# Pretend this is a packages.",
                'README.txt': 'Info about this packages',
            },
            sources,
        )
        ...
        # files for Python modules but not for packages data files
    ...
    def test_namespace_package_does_not_warn(self, caplog):
        ...
        and included warns for packages directories that did not contain
        ``__init__.py`` files.
        ...
        """
        # Create a fake project structure with a packages namespace:
        tmp = self.mkdtemp()
        ...
        assert not any(
            "packages init file" in msg and "not found" in msg for msg in caplog.messages
        )
