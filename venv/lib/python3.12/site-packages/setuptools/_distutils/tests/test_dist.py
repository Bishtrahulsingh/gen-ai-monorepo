...
class TestMetadata(support.TempdirManager):
    ...
    def test_simple_metadata(self):
        attrs = {"name": "packages", "version": "1.0"}
    ...
    def test_provides(self):
        attrs = {
            "name": "packages",
            "version": "1.0",
            "provides": ["packages", "packages.sub"],
        }
        dist = Distribution(attrs)
        assert dist.metadata.get_provides() == ["packages", "packages.sub"]
        assert dist.get_provides() == ["packages", "packages.sub"]
        meta = self.format_metadata(dist)
    ...
    def test_provides_illegal(self):
        with pytest.raises(ValueError):
            Distribution(
                {"name": "packages", "version": "1.0", "provides": ["my.pkg (splat)"]},
            )
    ...
    def test_requires_illegal(self):
        with pytest.raises(ValueError):
            Distribution(
                {"name": "packages", "version": "1.0", "requires": ["my.pkg (splat)"]},
            )

    def test_requires_to_list(self):
        attrs = {"name": "packages", "requires": iter(["other"])}
        dist = Distribution(attrs)
    ...
    def test_obsoletes_illegal(self):
        with pytest.raises(ValueError):
            Distribution(
                {"name": "packages", "version": "1.0", "obsoletes": ["my.pkg (splat)"]},
            )

    def test_obsoletes_to_list(self):
        attrs = {"name": "packages", "obsoletes": iter(["other"])}
        dist = Distribution(attrs)
    ...
    def test_long_description(self):
        ...
        attrs = {"name": "packages", "version": "1.0", "long_description": long_desc}
