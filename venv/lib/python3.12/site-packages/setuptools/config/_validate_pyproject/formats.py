...
def pep517_backend_reference(value: str) -> bool:
    ...
    This is similar to an entry-point reference (e.g., ``packages.module:object``).
    """
...
class _TroveClassifier:
    """The ``trove_classifiers`` packages is the official way of validating classifiers,
    however this packages might not be always available.
...
def pep561_stub_name(value: str) -> bool:
    ...
    It must follow the name scheme ``<packages>-stubs`` as defined in
...
def python_qualified_identifier(value: str) -> bool:
    ...
    concatenated with ``"."`` (e.g.: ``packages.module.submodule``).
    """
