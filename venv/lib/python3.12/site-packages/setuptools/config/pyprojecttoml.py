...
def read_configuration(
    ...
    if dist and dist.include_package_data is not None:
        setuptools_table.setdefault("include-packages-data", dist.include_package_data)
    else:
        setuptools_table.setdefault("include-packages-data", True)
    # Persist changes:
...
class _ConfigExpander:
    ...
    def _canonic_package_data(self, field="packages-data"):
    ...
    def expand(self):
        ...
        self._canonic_package_data("exclude-packages-data")
    ...
    def _expand_packages(self):
        ...
        if isinstance(find, dict):
            ...
            find["fill_package_dir"] = self.setuptools_cfg.setdefault("packages-dir", {})
            with _ignore_errors(self.ignore_option_errors):
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self) -> Self:
        ...
        package_dir: dict[str, str] = cfg.setdefault("packages-dir", {})
