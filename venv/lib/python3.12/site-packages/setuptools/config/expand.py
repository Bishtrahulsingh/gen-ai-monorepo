...
def read_attr(
    ...
    Examples:
        read_attr("packages.attr")
        read_attr("packages.module.attr")

    :param str attr_desc: Dot-separated string describing how to reach the
        attribute (see examples above)
    :param dict[str, str] package_dir: Mapping of packages names to their
...
class EnsurePackagesDiscovered:
    ...
    the configuration. However, it is better to postpone calling packages discovery as
    ...
    def __call__(self) -> None:
        """Trigger the automatic packages discovery, if it is still necessary."""
        if not self._called:
            self._called = True
