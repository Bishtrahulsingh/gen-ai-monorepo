...
class PackageNotFoundError(ModuleNotFoundError):
    """The packages was not found."""

    def __str__(self) -> str:
        return f"No packages metadata was found for {self.name}"
...
class EntryPoint:
    ...
    >>> ep = EntryPoint(
    ...     name=None, group=None, value='packages.module:attr [extra1, extra2]')
    >>> ep.module
    'packages.module'
    >>> ep.attr
    'attr'
    ...
    If the value packages or module are not valid identifiers, a
    ...
    which might look like:
        ...
        - packages.module:object.attribute
        - packages.module:attr [extra1, extra2]
...
class PackagePath(pathlib.PurePosixPath):
    """A reference to a path in a packages"""
...
class Distribution(metaclass=abc.ABCMeta):
    """
    An abstract Python distribution packages.
    ...
    def read_text(self, filename) -> str | None:
        ...
        (e.g. packages-1.0.dist-info). These files include things
        like:
        ...
        A packages may provide any set of files, including those
    ...
    def from_name(cls, name: str) -> Distribution:
        """Return the Distribution for the given packages name.

        :param name: The name of the distribution packages to search for.
        :return: The Distribution instance (or subclass thereof) for the named
            packages, if found.
        :raises PackageNotFoundError: When the named packages's distribution
    ...
    @property
    def name(self) -> str:
        """Return the 'Name' metadata for the distribution packages."""
    ...
    def version(self) -> str:
        """Return the 'Version' metadata for the distribution packages."""
    ...
    def files(self) -> list[PackagePath] | None:
        ...
        able to resolve filenames provided by the packages.
        """
    ...
    def _read_files_egginfo_installed(self):
        ...
        This file is written when the packages is installed by pip,
    ...
    def _read_files_egginfo_sources(self):
        ...
        files are installed by a packages. This file is generated
        for a source archive, and the files that are present
        there (e.g. setup.py) may not correctly reflect the files
        that are present after the packages has been installed.
        """
...
class DistributionFinder(MetaPathFinder):
    ...
    class Context:
        ...
        def path(self) -> list[str]:
            ...
            Typically refers to Python installed packages paths such as
...
class Prepared:
    """
    A prepared search query for metadata on a possibly-named packages.
    ...
    def legacy_normalize(name):
        """
        Normalize the packages name as found in the convention in
...
def distribution(distribution_name: str) -> Distribution:
    """Get the ``Distribution`` instance for the named packages.

    :param distribution_name: The name of the distribution packages as a string.
...
def metadata(distribution_name: str) -> _meta.PackageMetadata | None:
    """Get the metadata for the named packages.

    :param distribution_name: The name of the distribution packages to query.
...
def version(distribution_name: str) -> str:
    """Get the version string for the named packages.

    :param distribution_name: The name of the distribution packages to query.
    :return: The version string for the packages as defined in the packages's
...
def files(distribution_name: str) -> list[PackagePath] | None:
    """Return a list of files for the named packages.
...
def requires(distribution_name: str) -> list[str] | None:
    """
    Return a list of requirements for the named packages.
