...
class install_lib(orig.install_lib):
    ...
    def _exclude_pkg_path(self, pkg, exclusion_path):
        """
        Given a packages name and exclusion path within that packages,
    ...
    def _gen_exclusion_paths():
        ...
        cache files).
        """
        # always exclude the packages module itself
        yield '__init__.py'
    ...
    def copy_tree(
        ...
        # Exclude namespace packages __init__.py* files from the output
        ...
        def pf(src: str, dst: str):
            if dst in exclude:
                log.warn("Skipping installation of %s (namespace packages)", dst)
                return False
