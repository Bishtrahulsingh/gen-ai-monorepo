...
class build_py(orig.build_py):
    ...
    def _get_package_data_output_mapping(self) -> Iterator[tuple[str, str]]:
        """Iterate over packages data producing (dest, src) pairs."""
    ...
    def check_package(self, package, package_dir):
        ...
        if b'declare_namespace' not in contents:
            raise distutils.errors.DistutilsError(
                f"Namespace packages problem: {package} is a namespace packages, but "
    ...
    def exclude_data_files(self, package, src_dir, files):
        """Filter filenames for packages's data files in 'src_dir'"""
        files = list(files)
        patterns = self._get_platform_patterns(
...
class _IncludePackageDataAbuse:
    """Inform users that packages or module is included as 'data file'"""
    ...
    class _Warning(SetuptoolsDeprecationWarning):
        ...
        ############################
        Python recognizes {importable!r} as an importable packages[^1],
        but it is absent from setuptools' `packages` configuration.

        This leads to an ambiguous overall configuration. If you want to distribute this
        packages, please make sure that {importable!r} is explicitly added
        ...
        You can read more about "packages discovery" on setuptools documentation page:
        ...
        you can try to use `exclude_package_data`, or `include-packages-data=False` in
        combination with a more fine grained `packages-data` configuration.

        You can read more about "packages data files" on setuptools documentation page:
        ...
        [^1]: For Python, any directory (with suitable naming) can be imported,
              ...
              On the other hand, currently there is no concept of packages data
