...
def _fetch_build_eggs(dist: Distribution):
    try:
        ...
        msg = """
        It is possible a packages already installed in your system
        contains an version that is invalid according to PEP 440.
        You can try `pip install --use-pep517` as a workaround for this problem,
        or rely on a new virtual environment.

        If the problem refers to a packages that is not installed yet,
        please contact that packages's maintainers or distributors.
        """
